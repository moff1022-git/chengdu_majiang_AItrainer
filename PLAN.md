...
> **当前功能主线**：F0028-1–2 Done；[F0028-3 确定性 PlayerView 策略](docs/features/F0028_3_deterministic_player_view_policy.md) `Approved`，待实现。
---
...
3. 实施并验收已批准的 [`F0028-3`](docs/features/F0028_3_deterministic_player_view_policy.md)，随后每个切片继续先写子规格并单独验收回写
