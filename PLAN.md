...
> **当前功能主线**：F0028-1–5 Done；F0028-6 训练空间与回归评估子规格 Approved，进入实现。
---
...
> **M11 之后**：功能增量见 `docs/features/Fxxxx`（F0001–F0027 已实现；F0028 人类化 AI v2 的 F0028-1–5 已 Done；当前应用 **v0.2.1**）。
