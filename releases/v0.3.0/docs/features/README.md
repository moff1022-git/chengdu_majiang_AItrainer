...
| **F0028** | [F0028_humanlike_ai_v2_implementation_plan.md](F0028_humanlike_ai_v2_implementation_plan.md) | **人类化 AI v2**：GP/RP、实体牌/视图隔离、有限认知、决策回放、训练契约 | **Done**（F0028-1–6） |
...
| **F0031** | [F0031_humanlike_quantitative_acceptance.md](F0031_humanlike_quantitative_acceptance.md) | 人类化功能量化验收：机制、语义、风格、强度、真人相似、学习与性能分层门禁 | **Draft** |
| **F0032** | [F0032_humanlike_evaluation_dataset.md](F0032_humanlike_evaluation_dataset.md) | Humanlike 评估数据集：来源、schema、切分、覆盖、质量、隐私和版本契约 | **Draft** |
| **F0033** | [F0033_humanlike_ai_complete_software_design.md](F0033_humanlike_ai_complete_software_design.md) | 两份源规格统一软件设计：完整流程、模块契约及 AU-001～AU-096 量化目标 | **Draft** |
