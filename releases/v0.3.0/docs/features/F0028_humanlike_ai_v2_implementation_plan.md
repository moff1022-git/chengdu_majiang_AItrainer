...
> 字段级子规格：[F0028_4_human_cognition.md](F0028_4_human_cognition.md)，当前 `Done`（2026-07-29）。
...
**实现结果**：已完成。新增有限记忆、Top-K 注意力、持续认知状态、满意停止、有界噪声和模型思考时间；全量 332 passed / 1 skipped；150 局零崩溃/非法动作；详见子规格及 F0028-4 验收报告。
