...
> 2026-07-29 — **F0028-3 Done；Human 换三张实体牌混用已修复并通过人工复测**
...
| 序 | 动作 | 产出 / 依赖 | 建议触发语 |
|----|------|-------------|------------|
| 1 | 补验 MT-03 策略列表并执行完整场景（立即下一步） | 显示项确认、MT-06～17、2/3 人、性能体感；快速集已放行 | `继续执行 F0028-3 完整人工测试` |
| 2 | 编写、确认并实现 F0028-4 | 认知、人格、注意力、记忆、满意停止和有界噪声；人工阻塞已清零 | 按 F0028-4 触发 |
| 3 | 编写、确认并实现 F0028-5–6 | 审计回放 → 训练契约 | 按对应 F 编号触发 |
