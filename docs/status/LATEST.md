...
- README 已加入 Windows 实机截取的 Humanlike v2 双层人格雷达图截图。
...
- GitHub首页README已从0.3.1更新为0.3.2，包含Release下载、SHA、Nonhuman盲测结果和详细文档入口。
- README的0.3.2更新说明已增加Nonhuman vs Expert的9000/11000局对比表、95% CI、行为护栏及结论边界。
