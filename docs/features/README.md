...
| **F0028-2** | [F0028_2_physical_tiles_player_view_v2.md](F0028_2_physical_tiles_player_view_v2.md) | 实体牌 ID、schema 5 迁移、事件断言、PlayerView v2 白名单与 oracle 分离 | **Approved**（待实现） |
