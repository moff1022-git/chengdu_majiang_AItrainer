...
| **F0028** | [F0028_humanlike_ai_v2_implementation_plan.md](F0028_humanlike_ai_v2_implementation_plan.md) | **人类化 AI v2**：GP/RP、实体牌/视图隔离、有限认知、决策回放、训练契约 | **In Progress**（F0028-1–4 Done；F0028-5 Approved） |
...
| **F0028-5** | [F0028_5_decision_audit_replay.md](F0028_5_decision_audit_replay.md) | 私有决策审计、规范哈希链、认知/RNG 快照与策略复演 | **Approved** |
