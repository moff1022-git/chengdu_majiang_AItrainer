...
| **F0028** | [F0028_humanlike_ai_v2_implementation_plan.md](F0028_humanlike_ai_v2_implementation_plan.md) | **人类化 AI v2**：GP/RP、实体牌/视图隔离、有限认知、决策回放、训练契约 | **In Progress**（F0028-1–2 Done） |
